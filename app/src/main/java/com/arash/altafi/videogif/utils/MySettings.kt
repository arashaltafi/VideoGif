...
object MySettings {
    private val PREFERENCES_SETTINGS =
    ...
    private const val BOOLEAN_ALWAYS_SHOW_MORE_OPTIONS_WHEN_CONVERTING_GIF =
        "boolean_always_show_more_options_when_converting_gif"
    ...
    var alwaysShowMoreOptionsWhenConvertingGif
        get() = get(
            BOOLEAN_ALWAYS_SHOW_MORE_OPTIONS_WHEN_CONVERTING_GIF,
            BOOLEAN_ALWAYS_SHOW_MORE_OPTIONS_WHEN_CONVERTING_GIF_DEFAULT
        )
